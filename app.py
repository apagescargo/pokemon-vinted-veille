...
MOTS_CLES_DEFAUT = "\n".join([
    ...
    # noms des extensions EV
    "lot evolutions paldea pokemon",
    "lot flammes obsidiennes pokemon",
    "lot 151 pokemon",
    "lot faille paradoxe pokemon",
    "lot destinees paldea pokemon",
    "lot forces temporelles pokemon",
    "lot mascarade crepusculaire pokemon",
    "lot fable nebuleuse pokemon",
    "lot couronne stellaire pokemon",
    "lot etincelles deferlantes pokemon",
    "lot evolutions prismatiques pokemon",
    "lot aventures ensemble pokemon",
    "lot rivalites destinees pokemon",
    "lot foudre noire pokemon",
    "lot flamme blanche pokemon",
    # ── Épée et Bouclier ──────────────────────────────────────────────────────
    ...
    "lot CRZ pokemon",
    # noms des extensions EB
    "lot clash rebelles pokemon",
    "lot tenebres embrasees pokemon",
    "lot voltage eclatant pokemon",
    "lot destinees radieuses pokemon",
    "lot styles combat pokemon",
    "lot regne glace pokemon",
    "lot evolution celeste pokemon",
    "lot celebrations pokemon",
    "lot poing fusion pokemon",
    "lot stars etincelantes pokemon",
    "lot astres radieux pokemon",
    "lot origine perdue pokemon",
    "lot tempete argentee pokemon",
    "lot zenith supreme pokemon",
